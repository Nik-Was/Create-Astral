(function createMixingRecipes() {
  ...
  onEvent("recipes", (event) => {
    ...
    const mixingRecipes = [
      ...
      {
        output: Fluid.of("tconstruct:molten_electrum", INGOT),
        input: [Item.of("techreborn:silver_nugget", 9), Item.of("minecraft:gold_nugget", 9)],
        heat: "heated",
        time: 100,
      },
      {
      ...
      },
      {
        ...
        input: [
          { fluid: "tconstruct:molten_cobalt", amount: INGOT},
          { fluid: "tconstruct:molten_slimesteel", amount: INGOT * 2 },
        ],
        heat: "heated",
        time: 100,
      },
      {
        output: Fluid.of("tconstruct:molten_queens_slime", INGOT * 2),
        input: [Item.of("tconstruct:cobalt_nugget", 9), Item.of("tconstruct:slimesteel_nugget", 18)],
        heat: "heated",
        time: 100,
      },
      {
      ...
      },
      {
        ...
        input: [Item.of("tconstruct:cobalt_nugget", 9), Item.of("techreborn:lead_nugget", 18)],
        heat: "heated",
        time: 100,
      },
      {
        ...
        input: [
          { fluid: "tconstruct:molten_cobalt", amount: INGOT },
          { fluid: "tconstruct:molten_lead", amount: INGOT * 2 },
        ],
        heat: "heated",
        time: 100,
      },
      ...
      //Commented out every enchantment that exceeds vanilla since anvils don't let you do that anyways. To be fixed
      // {
      ...
      {
        output: Fluid.of("tconstruct:molten_netherite", INGOT / 4),
        input: [
      ...
      {
        output: [{ fluid:"create:chocolate", amount: BUCKET / 3 }],
        input: ["minecraft:cocoa_beans", { fluid: "astralfoods:cream", amount: BUCKET / 3 }],
        heat: "heated",
        time: 100,
      },
      {
